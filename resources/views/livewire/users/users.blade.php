    ...
    <div class="col-sm-12">
        ...
        <div class="widget widget-chart-one">
            ...
            <div class="d-flex align-items-center mb-3">
                <input type="text" wire:model.live="searchengine" class="form-control" placeholder="Buscar...">
                ...
                <div class="table-responsive">
                    <table class="table-bordered table striped mt-1">
                        <thead class="text-white" style="background: #3B3F5C;">
                            <tr>
                                <th class="table-th fs-5 text-white">Nombre</th>
                                <th class="table-th fs-5 text-white">Usuario</th>
                                <th class="table-th fs-5 text-white">Email</th>

                                <th class="table-th fs-5 text-white">Teléfono</th>
                                <th class="table-th fs-5 text-white">Roles</th>
                                <th class="table-th fs-5 text-white">Estado</th>

                                <th class="table-th fs-5 text-white">Imagen</th>
                                <th class="table-th fs-5 text-white">Acciones</th>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="">
                                        @if ($user->image != null)
                                            <span><img src="{{ asset('storage/users' . $user->image) }}" alt="example"
