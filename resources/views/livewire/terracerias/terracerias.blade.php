<div class="row sales layout-top-spacing mt-4">
    ...
    @include('livewire.terracerias.form')


    <script>
        document.addEventListener('livewire:initialized', () => {
            @this.on('terra-added', msg => {
                $('#themodal').modal('hide');

            })
            @this.on('terra-updated', msg => {
                $('#themodal').modal('hide');
                //   noty(msg);

            })
            @this.on('terra-deleted', msg => {
