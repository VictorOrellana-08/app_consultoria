...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" wire:model.lazy='name' class="form-control" placeholder="Maquinaria"
    ...
    <div class="col-sm-12">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text d-flex align-items-center fas fa-edit" id="basic-addon1"></span>
            <input type="text" wire:model.lazy='barcode' class="form-control" placeholder="codigo"
                aria-label="Username" aria-describedby="basic-addon1">
        </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="input-group mb-3">
            <span class="input-group-text d-flex align-items-center fas fa-edit" id="basic-addon1"></span>
            <input type="text" wire:model.lazy='price' class="form-control" placeholder="precio"
                aria-label="Username" aria-describedby="basic-addon1">
        </div>
